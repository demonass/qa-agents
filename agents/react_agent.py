...
from agents.tool_manager import Tool, ToolManager, tool_manager
from agents.skill_router import SkillRouter, SkillInfo, skill_router
from prompts.react_prompt import (
    ReActPrompt, ReActMessage, ToolInfo, build_react_system_prompt
)
...
class ReActAgent:
    ...
    def __init__(
        ...
        Args:
            ...
            verbose: 是否输出详细日志
        """
        self.tool_manager = tool_manager or tool_manager
        self.skill_router = skill_router or skill_router
